...
Ce projet propose un système pour le scoring crédit, conçu pour aider les institutions bancaires (prêt à dépenser) à évaluer le risque de défaut de paiement de manière transparente et automatisée.
...
- **Présentation Canva** : [Lien Canva](https://canva.link/hbi93k461sp1jwb)
...
- **Explicabilité (SHAP)** : Analyse détaillée des facteurs influençant chaque décision (transparence).
- **Dashboard** : Interface Streamlit avec 3 onglets (Décision, SHAP, Profil Détaillé).
